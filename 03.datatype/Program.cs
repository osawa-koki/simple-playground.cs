...
// 次にデータ型の確認方法を説明します。
// データ型の確認方法は、変数の型を確認するGetType()メソッドを使用します。
// このメソッドは、変数の型を返します。
...
// また、変数の型を確認するGetType()メソッドは、変数の型を返すので、
// そのまま変数に代入することもできます。
...
// また、is演算子を使用することで、変数の型を確認することもできます。

int g = 1;
Console.WriteLine(g is int);
Console.WriteLine(g is float);
// >>> True
// >>> False

float h = 1.0f;
Console.WriteLine(h is int);
Console.WriteLine(h is float);
// >>> False
// >>> True
